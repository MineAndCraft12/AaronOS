...
<html>
    <head>
        ...
        <script defer>
            ...
            window.requestAnimationFrame(function(){
                ...
                boxDiv.innerHTML += '<div id="blurbox"></div>';
                for(var i = 0; i < 1024; i++){// id="b' + i + '"
                    document.getElementById('blurbox').innerHTML += '<div class="blurboxes" style="left:' + i + 'px"></div>';
                }
                for(var i = 0; i < 1024; i++){// id="b' + i + '"
                    boxDiv.innerHTML += '<div class="box" style="left:' + i + 'px"></div>';
                }
                boxes = document.getElementsByClassName('box');
                blurs = document.getElementsByClassName('blurboxes');
                big = 0;
                makeBig = function(){
                    if(!big){
                        big = 1;
                ...
                renderFrame = function(){
                    ...
                    for(var i = 0; i < 1024; i++){
                        ...
                        blurs[i].style.height = freqDat + 'px';
                        blurs[i].style.backgroundColor = 'rgba(0,255,' + (255 - freqDat) + ',' + (freqDat / 255) + ')';
                    }
    ...
    <body>
        ...
        <audio id="msAudio" src="" onended="if(resetAfter){window.location='https://aaron-os-mineandcraft12.c9.io/unrelated/keyfingers/ultra.php?random=true';}"></audio>
        <div id="loadDiv">
        ...
        <div style="position:absolute;top:0;left:0;z-index:100">
            ...
            <!--<button style="background-color:red;" onclick="audio.pause();audioMusic.pause();audio.currentTime += 5;audioMusic.currentTime += 5;audio.play();audioMusic.play();">&gt;&gt;</button>-->
            <button onclick="window.location='ultra.php'">New</button>
            ...
            <button onclick="window.location='https://aaron-os-mineandcraft12.c9.io/unrelated/keyfingers/ultra.php?random=true';">Randomize</button>
            <button onclick="window.location='https://aaron-os-mineandcraft12.c9.io/unrelated/keyfingers/visual.php';">Old Render System</button>
        </div>
        <?php
