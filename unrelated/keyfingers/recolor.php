...
<html>
                ...
                */
                renderFrame = function(){
                    ...
                    */
                    ...
                    for(var i = 0; i < 1024; i++){
                        //avg += frequencyData[i];
                        if(frequencyData[i] > 75){
                            avg++;
                        }
                    }
                    avg /= 1024;
                    avg *= 255;
                    //avg = Math.max(...frequencyData) - (255 - avg);
                    document.title = Math.round(avg) + ' recolor';
                };
    ...
    <body>
        ...
        <audio id="msAudio" src="" onended="if(resetAfter){window.location='https://aaron-os-mineandcraft12.c9.io/unrelated/keyfingers/recolor.php?random=true';}"></audio>
        <div id="loadDiv">
            <div id="loadTotal"></div>
            <div id="loadTime"></div>
        </div>
        <div id="audioBoxesDiv">This visualizer will pulse the colors of your windows along with the music. Your personal window settings are not affected.</div>
        <div style="position:absolute;top:0;left:0;z-index:100">
            ...
            <!--<button style="background-color:red;" onclick="audio.pause();audioMusic.pause();audio.currentTime += 5;audioMusic.currentTime += 5;audio.play();audioMusic.play();">&gt;&gt;</button>-->
            <button onclick="window.location='recolor.php'">New</button>
