                ...
                */
                ...
                renderFrame = function(){
                    ...
                    if(!big){
                        for(var i = 0; i < 1024; i++){
                            ...
                            vctx.lineTo(i + 0.5, 0); //(255 - frequencyData[i]));
                            vctx.stroke();
                        }
                    }else{
                        for(var i = 0; i < 1024; i++){
                            ...
                            vctx.lineTo(Math.round(i * transformFact[0]) + 0.5, Math.round(/*(255 - frequencyData[i])*/0 * transformFact[1]));
                            vctx.stroke();
                            if(Math.round((i + 1) * transformFact[0]) - Math.round(i * transformFact[0]) > 1 && i !== 1023){
                                ...
                                vctx.lineTo(Math.round(i * transformFact[0]) + 1.5, Math.round(/*(255 - tempMedian)*/0 * transformFact[1]));
                                vctx.stroke();
                            }
                        }
                    }
                ...
                startSong = function(file){
                    ...
                    audio.oncanplaythrough = function(){
                        if(loadsReady){
                            if(!big){
                                makeBig([window.innerWidth, parseInt(document.getElementById('tskbrSize').value)], 1);
                            }
