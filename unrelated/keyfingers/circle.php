...
<html>
        ...
        <script defer>
            ...
            window.requestAnimationFrame(function(){
                ...
                for(var i = 0; i < 1024; i++){// id="b' + i + '"
                    boxDiv.innerHTML += '<div class="box" style="transform:rotate(' + (i * 0.3515625) + 'deg);transform-origin:50% 0;"></div>';
                }
                ...
                makeBig = function(){
                    if(!big){
                        big = 1;
                        document.getElementById('audioBoxesDiv').style.transform = 'scale(' + (parseInt(window.innerHeight, 10) / 512) + ')';
                ...
                renderFrame = function(){
                    ...
                    for(var i = 0; i < 1024; i++){
                        ...
                        boxes[i].style.bottom = 255 - freqDat + 'px';
                        boxes[i].style.zIndex = freqDat;
                    }
                ...
                startSong = function(file){
                    ...
                    audio.oncanplaythrough = function(){
                        if(loadsReady){
                            ...
                            audio.play();
                            document.getElementById('loadTotal').style.width = Math.floor(audioMusic.buffered.end(0) / audioMusic.duration * 512) + "px";
                            document.getElementById('loadTime').style.width = Math.floor(audioMusic.currentTime / audioMusic.duration * 512) + "px";
    ...
    <body>
        ...
        <audio id="msAudio" src="" onended="if(resetAfter){window.location='https://aaron-os-mineandcraft12.c9.io/unrelated/keyfingers/circle.php?random=true';}"></audio>
        <div id="loadDiv">
        ...
        <div style="position:absolute;top:0;left:0;z-index:100">
            ...
            <!--<button style="background-color:red;" onclick="audio.pause();audioMusic.pause();audio.currentTime += 5;audioMusic.currentTime += 5;audio.play();audioMusic.play();">&gt;&gt;</button>-->
            <button onclick="window.location='circle.php'">New</button>
            ...
            <button onclick="window.location='https://aaron-os-mineandcraft12.c9.io/unrelated/keyfingers/circle.php?random=true';">Randomize</button>
            <button onclick="window.location='https://aaron-os-mineandcraft12.c9.io/unrelated/keyfingers/center.php';">Centered</button>
        </div>
        <?php
