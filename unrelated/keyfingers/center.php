...
<html>
            ...
            window.requestAnimationFrame(function(){
                ...
                renderFrame = function(){
                    ...
                    for(var i = 0; i < 1024; i++){
                        ...
                        boxes[i].style.bottom = (255 - freqDat) / 2 + 'px';
    ...
    <body>
        ...
        <audio id="msAudio" src="" onended="if(resetAfter){window.location='https://aaron-os-mineandcraft12.c9.io/unrelated/keyfingers/center.php?random=true';}"></audio>
        <div id="loadDiv">
        ...
        <div style="position:absolute;top:0;left:0;z-index:100">
            ...
            <!--<button style="background-color:red;" onclick="audio.pause();audioMusic.pause();audio.currentTime += 5;audioMusic.currentTime += 5;audio.play();audioMusic.play();">&gt;&gt;</button>-->
            <button onclick="window.location='center.php'">New</button>
            ...
            <button onclick="window.location='https://aaron-os-mineandcraft12.c9.io/unrelated/keyfingers/center.php?random=true';">Randomize</button>
            <button onclick="window.location='https://aaron-os-mineandcraft12.c9.io/unrelated/keyfingers/ultracnv.php';">Ultra</button>
        </div>
        <?php
