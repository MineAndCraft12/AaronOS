...
c(function(){
    ...
    window.aOSversion = 'B0.8.0.0 (06/12/2018) r1';
...
c(function(){
    ...
    initStatus = 1;
    doLog('Took ' + perfCheck('masterInitAOS') + '&micro;s to initialize.');
